...
> 7. *Partial-run measurements (first 5781/46963 tests)* — +37 improvements in built-ins/Array, +10 in built-ins/Function, −7 false-positive corrections (net +40). Full targeted snapshot (built-ins/Array/prototype + built-ins/Object, 6221 tests) running; Phase 27 baseline for that section: 2131/6221 (34.3%). Full-suite snapshot pending.
