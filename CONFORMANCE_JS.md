...
> To be updated using the latest snapshot generated by `test262_runner.js`.

| Folder                      | Total | Passed | Failed (syntax) | Failed (semantics) | Timeouts | Notes |
|-----------------------------|-------|--------|-----------------|--------------------|----------|-------|
| `language/expressions`      |   TBD |   TBD  |         TBD     |          TBD       |    TBD   | Operand stack, coercions, operator semantics. |
| `language/statements`       |   TBD |   TBD  |         TBD     |          TBD       |    TBD   | Control flow, blocks, loops, break/continue. |
