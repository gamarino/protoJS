...
This document tracks implementation status of the **TEST_PLAN.md** (Phase 1: Semantic Conformity; that plan is no longer in the repository). Update it as tests are added, run, or fixed.
